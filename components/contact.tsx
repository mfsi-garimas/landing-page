    ...
    return (
        <section className="contact-section container" id="contact">
            ...
            <div className="col-12 col-md-6 contact-left">
                ...
                <img src="/images/child-avatar-illustration-happy-boy-avatar-cartoon-user-portrait-user-profile-icon_118339-4378.jpg" alt="3D Illustration" className="img-fluid d-block mx-auto mb-4 contact-div" />
